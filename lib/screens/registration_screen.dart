...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userTypeField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Enter Valid user type !(User type must type in lowercase and only characters)");
          }
          return null;
        },
        onSaved: (value) {
    ...
    final firstNameField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Enter Valid Name (Only characters allowed)");
          }
          return null;
        },
        onSaved: (value) {
  ...
  postDetailsToFirestore() async {
    ...
    userModel.userType = userTypeEditingController.text;
